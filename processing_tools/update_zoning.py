...
try:
    ...
    print("Usage: python update_zoning.py <county> <city>")
    sys.exit(0)
...
# adding dissolve and explode to single part functionality
    ...
    DROP TABLE IF EXISTS raw_lake_unincorporated_dissolve;
    ...
    INSERT INTO raw_lake_unincorporated (wkb_geometry,""" + select_col_list + """)
...
# adding dissolve and explode to single part functionality
    ...
    set enable_hashagg to off;    
    -- st_union parcels based on zon_code
    DROP TABLE IF EXISTS raw_osceola_st_cloud_dissolve;
    CREATE TABLE """ + temp_table_name + """_dissolve AS
    SELECT 
        ST_UNION(wkb_geometry) as wkb_geometry,  
        """ + select_col_list + """
    ...
    sql = """
    TRUNCATE """ + temp_table_name + """;
    INSERT INTO raw_osceola_st_cloud (wkb_geometry,""" + select_col_list + """)
    SELECT (ST_DUMP(wkb_geometry)).geom, """ + select_col_list + """
    FROM """ + temp_table_name + """_dissolve;
    """
...
# adding dissolve and explode to single part functionality
    ...
    set enable_hashagg to off;    
    -- st_union parcels based on zon_code
    DROP TABLE IF EXISTS raw_seminole_casselberry_dissolve;
    CREATE TABLE """ + temp_table_name + """_dissolve AS
    SELECT 
        ST_UNION(wkb_geometry) as wkb_geometry,  
        """ + select_col_list + """
    ...
    sql = """
    TRUNCATE """ + temp_table_name + """;
    INSERT INTO raw_seminole_casselberry (wkb_geometry,""" + select_col_list + """)
    SELECT (ST_DUMP(wkb_geometry)).geom, """ + select_col_list + """
    FROM """ + temp_table_name + """_dissolve;
    """
...
# adding dissolve and explode to single part functionality
    ...
    set enable_hashagg to off;    
    -- st_union parcels based on zon_code
    DROP TABLE IF EXISTS raw_seminole_longwood_dissolve;
    CREATE TABLE """ + temp_table_name + """_dissolve AS
    SELECT 
        ST_UNION(wkb_geometry) as wkb_geometry,  
        """ + select_col_list + """
    ...
    sql = """
    TRUNCATE """ + temp_table_name + """;
    INSERT INTO raw_seminole_longwood (wkb_geometry,""" + select_col_list + """)
    SELECT (ST_DUMP(wkb_geometry)).geom, """ + select_col_list + """
    FROM """ + temp_table_name + """_dissolve;
    """
...
# adding dissolve and explode to single part functionality
    ...
    set enable_hashagg to off;    
    -- st_union parcels based on zon_code
    DROP TABLE IF EXISTS raw_seminole_oviedo_dissolve;
    CREATE TABLE """ + temp_table_name + """_dissolve AS
    SELECT 
        ST_UNION(wkb_geometry) as wkb_geometry,  
        """ + select_col_list + """
    ...
    sql = """
    TRUNCATE """ + temp_table_name + """;
    INSERT INTO raw_seminole_oviedo (wkb_geometry,""" + select_col_list + """)
    SELECT (ST_DUMP(wkb_geometry)).geom, """ + select_col_list + """
    FROM """ + temp_table_name + """_dissolve;
    """
...
# adding dissolve and explode to single part functionality
    ...
    set enable_hashagg to off;    
    -- st_union parcels based on zon_code
    DROP TABLE IF EXISTS raw_seminole_sanford_dissolve;
    CREATE TABLE """ + temp_table_name + """_dissolve AS
    SELECT 
        ST_UNION(wkb_geometry) as wkb_geometry,  
        """ + select_col_list + """
    ...
    sql = """
    TRUNCATE """ + temp_table_name + """;
    INSERT INTO raw_seminole_sanford (wkb_geometry,""" + select_col_list + """)
    SELECT (ST_DUMP(wkb_geometry)).geom, """ + select_col_list + """
    FROM """ + temp_table_name + """_dissolve;
    """
...
# adding dissolve and explode to single part functionality
    ...
    set enable_hashagg to off;    
    -- st_union parcels based on zon_code
    DROP TABLE IF EXISTS raw_seminole_winter_springs_dissolve;
    CREATE TABLE """ + temp_table_name + """_dissolve AS
    SELECT 
        ST_UNION(wkb_geometry) as wkb_geometry,  
        """ + select_col_list + """
    ...
    sql = """
    TRUNCATE """ + temp_table_name + """;
    INSERT INTO raw_seminole_winter_springs (wkb_geometry,""" + select_col_list + """)
    SELECT (ST_DUMP(wkb_geometry)).geom, """ + select_col_list + """
    FROM """ + temp_table_name + """_dissolve;
    """
...
# adding dissolve and explode to single part functionality
    ...
    set enable_hashagg to off;    
    -- st_union parcels based on zon_code
    DROP TABLE IF EXISTS raw_zon_st_lucie_unincorp_dissolve;
    CREATE TABLE """ + temp_table_name + """_dissolve AS
    SELECT 
        ST_UNION(wkb_geometry) as wkb_geometry,  
        """ + select_col_list + """
    ...
    sql = """
    TRUNCATE """ + temp_table_name + """;
    INSERT INTO raw_zon_st_lucie_unincorp (wkb_geometry,""" + select_col_list + """)
    SELECT (ST_DUMP(wkb_geometry)).geom, """ + select_col_list + """
    FROM """ + temp_table_name + """_dissolve;
    """
